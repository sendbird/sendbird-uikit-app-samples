...
describe('sendbird', () => {
    it('create a support message', () => {
        const mockMessage = "use this text when creating markdown app message";
        const sendbird = new Sendbird();
        const appData = sendbird.constructMarkdownSupportMessage(mockMessage);
        expect(appData).toEqual(`#### Hey James. How can I help you today?`);
    });
