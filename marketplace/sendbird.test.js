...
describe('sendbird', () => {
    it('create a marketplace message', () => {
        const mockMessage = "use this text when creating markdown app message";
        const sendbird = new Sendbird();
        const appData = sendbird.constructMarkdownMarketPlaceMessage(mockMessage);
        expect(appData).toEqual(`![alt marketplace hero image](https://scout-poc.pages.dev/static/media/banner-renew.fa578f5b.png#hero) \n #### Black long dress \n ### $50`)
    });
